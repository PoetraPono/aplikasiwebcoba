...
<ul class="nav" id="main-menu">
   ...
   <!-- <li><a href="#"><i class="fa fa-newspaper-o"></i> Berita<span class="fa arrow"></span></a>
    ...
    <li><a href="#"><i class="fa fa-wrench"></i> Unsafe Confition<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/produk')?>">Data Unsafe Condition</a></li>
            <li><a href="<?php echo base_url('admin/produk/tambah')?>">Tambah Unsafe Condition</a></li>
        </ul>
    </li> 
</ul>
